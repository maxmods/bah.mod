...
Type MyApp Extends CEGuiBaseApplication
	...
	Method initialise:Int()
		...
		' StaticImage
		TCEImagesetManager.createImagesetFromImageFile("ImageForStaticImage", "GPN-2000-001437.tga")
		...
		TCEImagesetManager.createImagesetFromImageFile("ImageForScrollablePane", "GPN-2000-001437.tga")
