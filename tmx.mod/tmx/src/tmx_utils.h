...
tmx_map* parse_xml_buf(const char *buffer, int buflen, const char *filename); /* tmx_xml.c */
tmx_map* parse_json(const char *filename); /* tmx_json.c */
tmx_map* parse_json_buf(const char *buffer, int buflen, const char *filename); /* tmx_json.c */
