...
Local db:TDBConnection = LoadDatabase("SQLITE_CRYPTO", "autotest.db")
...
If db.isOpen() Then
	...
	db = LoadDatabase("SQLITE_CRYPTO", "autotest.db")
	...
	db = LoadDatabase("SQLITE_CRYPTO", "autotest.db", , , "user", "password")
