...
If db.isOpen() Then
	...
	Local s:String = "CREATE TABLE person (id integer primary key, " + ..
	  " forename varchar(30)," + ..
	  " surname varchar(30), n1 number(10), n2 number(20), n3 number(10, 5) )"
	...
	query.prepare("INSERT INTO person values (0, :1, :2, :3, :4, :5)")
	...
	For Local i:Int = 0 Until names.length
		...
		query.bindValue(2, TDBInt.Set(12345))
		query.bindValue(3, TDBLong.Set(4567484948484:Long))
		query.bindValue(4, TDBDouble.Set(555.666))
	...
	While query.nextRow()
		...
		DebugLog(record.getLong(0) + ": Name = " + record.getString(1) + " " + record.getString(2) + ..
			" : " + record.getInt(3) + " : " + record.getLong(4) + " : " + record.getDouble(5))
	Wend
