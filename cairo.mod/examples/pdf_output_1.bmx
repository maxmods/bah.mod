...
' This is a very crude example of creating a PDF in Cairo.
' A better way would be to have methods specifically for doing things like page-numbering etc...



Local cairo:TCairo = TCairo.Create(TCairoPDFSurface.CreateForPDF("test1.pdf", TCairoPaperSize.PAPER_A4.width, TCairoPaperSize.PAPER_A4.height))
