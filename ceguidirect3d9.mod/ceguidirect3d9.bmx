...
Type TCEDirect3D9Renderer Extends TCERenderer
	...
	Method New()
		objectPtr = bmx_cegui_direct3d9renderer_new()
	End Method
	...
	Method createGLTexture:TCETexture(tex:Int, w:Float, h:Float)
		Return TCEDirect3D9Texture(bmx_cegui_direct3d9renderer_creategltexture(objectPtr, tex, w, h))
	End Method
	...
	Method enableExtraStateSettings(setting:Int)
		bmx_cegui_direct3d9renderer_enableextrastatesettings(objectPtr, setting)
	End Method
	...
	End Rem
	Method grabTextures()
		bmx_cegui_direct3d9renderer_grabtextures(objectPtr)
	End Method
	...
	Method restoreTextures()
		bmx_cegui_direct3d9renderer_restoretextures(objectPtr)
	End Method
